...
All routes are relative to `https://cs571api.cs.wisc.edu/rest/s25/hw9/`.
...
To upgrade to newer version of expo, i.e. expo 54, run the following commands:

```bash
npm install react-dom@19.1.0 react@19.1.0 expo@^54.0.0
npx expo install --fix
npx expo install babel-preset-expo@~54.0.10 -- --save-dev
npx expo install react-native-worklets
```

Then restrat expo with
